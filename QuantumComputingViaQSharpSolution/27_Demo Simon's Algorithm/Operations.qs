    ...
    operation HelloQ () : Unit {
		...
		using(inputQubits = Qubit[4])
		{
			...
			using(outputQubits = Qubit[4])
			{
				...
				//BlackBox0000(inputQubits, outputQubits);//Output should be 0000
				BlackBox1010(inputQubits, outputQubits);//Output should be 0000
				...
				//BlackBox0000(inputQubits, outputQubits);//Output should be same as input 1010
				BlackBox1010(inputQubits, outputQubits);//Output should be 0000 (same as that of the input 0000); because here s = 1010
				...
				//BlackBox0000(inputQubits, outputQubits);//Output should be same as input 1110
				BlackBox1010(inputQubits, outputQubits);//Output should be 0100
				...
				//BlackBox0000(inputQubits, outputQubits);//Output should be same as input 0100
				BlackBox1010(inputQubits, outputQubits);//Output should be 0100 (same as that of the input 1110; because s(1010) = 0100 xor 1110)
